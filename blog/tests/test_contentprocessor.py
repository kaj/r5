...
class ContentProcessorTest(TestCase):
    ...
    def test_process_simple_figure(self):
        ...
        EXPECTED = '\n'.join([
                '<figure class="image sidebar"><a href="/img/foo"><img src="/img/foo.i" width="200" height="133" alt="Bild"/></a></figure>',
                '<p>Lorem ipsum.</p>'
                ])
    ...
    def test_process_figure_with_title(self):
        ...
        EXPECTED = u''.join([
                ...
                '<a href="/img/foo" title="Foo"><img src="/img/foo.i" width="200" height="133" alt="Bild: Foo"/></a>',
                '</figure>',
                '<p>Lorem ipsum.</p>'
                ])
